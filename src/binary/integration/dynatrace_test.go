...
func testDynatrace(platform switchblade.Platform, fixtures, uri string) func(*testing.T, spec.G, spec.S) {
	return func(t *testing.T, context spec.G, it spec.S) {
		...
		context("deploying a binary app with Dynatrace agent with configured network zone", func() {
		...
		context("deploying with Dynatrace agent with a service that has tags", func() {
